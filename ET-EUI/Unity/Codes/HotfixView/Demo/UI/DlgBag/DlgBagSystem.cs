...
namespace ET
{
    public static class DlgBagSystem
    {
        ...
        public static void RegisterUIEvent(this DlgBag self)
        {
            ...
            self.View.E_BagItemsLoopVerticalScrollRect.AddItemRefreshListener((Transform transform, int index) =>
            {
                self.OnLoopItemRefreshHandler(transform, index);
            });
        }
        /// <summary>
        /// Toggle
        ...
        public static void RefeshPageIndexInfo(this DlgBag self)
        {
            ...
            int maxPageIndex = Mathf.CeilToInt(itemCount / 30.0f);//最小整数
