		...
		public UnityEngine.UI.Text E_EntryNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_EntryNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"ItemBackGroup/E_Entrys/Content/Item_entry/E_EntryName");
     			}
		...
		public UnityEngine.UI.Text E_EntryValueText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_EntryValueText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"ItemBackGroup/E_Entrys/Content/Item_entry/E_EntryValue");
     			}
