...
namespace ET
{
	...
	{
		//public ES_EquipItem_Head ES_EquipItem_Head
  //   	{
  //   		get
  //   		{
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_head = this.AddChild<ES_EquipItem_Head,Transform>(subTrans);
  //   			}
  //   			return this.m_es_equipitem_head;
  //   		}
  //   	}

		//public ES_EquipItem_Clothes ES_EquipItem_Clothes
  //   	{
  //   		get
  //   		{
  //   			if (this.uiTransform == null)
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_clothes = this.AddChild<ES_EquipItem_Clothes,Transform>(subTrans);
  //   			}
  //   			return this.m_es_equipitem_clothes;
  //   		}
  //   	}

		//public ES_EquipItem_Shoes ES_EquipItem_Shoes
  //   	{
  //   		get
  //   		{
  //   			if (this.uiTransform == null)
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_shoes = this.AddChild<ES_EquipItem_Shoes,Transform>(subTrans);
  //   			}
  //   			return this.m_es_equipitem_shoes;
  //   		}
  //   	}

		//public ES_EquipItem_Ring ES_EquipItem_Ring
  //   	{
  //   		get
  //   		{
  //   			if (this.uiTransform == null)
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_ring = this.AddChild<ES_EquipItem_Ring,Transform>(subTrans);
  //   			}
  //   			return this.m_es_equipitem_ring;
  //   		}
  //   	}

		//public ES_EquipItem_Weapon ES_EquipItem_Weapon
  //   	{
  //   		get
  //   		{
  //   			if (this.uiTransform == null)
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_weapon = this.AddChild<ES_EquipItem_Weapon,Transform>(subTrans);
  //   			}
  //   			return this.m_es_equipitem_weapon;
  //   		}
  //   	}

		//public ES_EquipItem_Shield ES_EquipItem_Shield
  //   	{
  //   		get
  //   		{
  //   			if (this.uiTransform == null)
  ...
  //   			{
		...
		//    	   this.m_es_equipitem_shield = this.AddChild<ES_EquipItem_Shield,Transform>(subTrans);
  //   			}
  ...
  //   	}
		...
		//private ES_EquipItem_Head m_es_equipitem_head = null;
		//private ES_EquipItem_Clothes m_es_equipitem_clothes = null;
		//private ES_EquipItem_Shoes m_es_equipitem_shoes = null;
		//private ES_EquipItem_Ring m_es_equipitem_ring = null;
		//private ES_EquipItem_Weapon m_es_equipitem_weapon = null;
		//private ES_EquipItem_Shield m_es_equipitem_shield = null;
