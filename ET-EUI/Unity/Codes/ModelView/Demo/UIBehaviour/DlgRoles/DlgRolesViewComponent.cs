		...
		public UnityEngine.UI.Text E_RoleNameText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_RoleNameText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_Roles/Content/Item_role/E_RoleName");
     			}
		...
		public UnityEngine.UI.Button E_RoleButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_RoleButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_Roles/Content/Item_role/E_Role");
     			}
		...
		public UnityEngine.UI.Image E_RoleImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_RoleImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_Roles/Content/Item_role/E_Role");
     			}
