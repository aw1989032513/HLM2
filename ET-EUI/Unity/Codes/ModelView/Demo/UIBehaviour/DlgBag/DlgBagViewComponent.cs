		...
		public UnityEngine.UI.Image E_QualityImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_QualityImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_BagItems/Content/Item_bagItem/E_Quality");
     			}
		...
		public UnityEngine.UI.Image E_IconImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_IconImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_BagItems/Content/Item_bagItem/E_Icon");
     			}
		...
		public UnityEngine.UI.Button E_SelectButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SelectButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_BagItems/Content/Item_bagItem/E_Select");
     			}
		...
		public UnityEngine.UI.Image E_SelectImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SelectImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"BackGround/ContentBackGround/E_BagItems/Content/Item_bagItem/E_Select");
     			}
